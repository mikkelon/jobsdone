...
use crate::domain::{
    self, BacklogView, Change, Command, DayView, Id, Model, MonthDay, NotesView, Pile, Place, Rule,
    SearchResults, Store, StoreError, Surfaced, Weekday, Write,
};
use crate::input::{
    self, Action, Binding, Field, KeyContext, NotesPane, Pane, PopupKind, ReviewStep,
};
...
impl App {
    ...
    fn place_of(&self, list: List) -> Place {
        match list {
            ...
            List::Day | List::Notes | List::Review => Place::Day(self.today),
        }
    }
